...
<div class="container-fluid">
<h1 style="color: red">위스키란 ? </h1>
<h3 style="color: white">보리 밀 옥수수를 주원료로 하여 이것을 당화 발효시킨 후 증류하여 만든 술이다.<br><br>
(위스키를 베이스로한 칵테일)
</h3>
<br>
 <div class="row">
    <div class="col">
<img src="../images2/맨하탄.jpg"  class="img-responsive" style="width: 250px;" align="left">
<h2 style="color: white;">&nbsp;&nbsp;Manhattan</h2><br>
<h4>&nbsp;&nbsp;<strong style="color: red;">Recipe</strong> Bourbon Wishkey 1.1 / 2oz<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sweet Vermouth 3 / 4oz<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Angrostura Bitters 1dash
</h4>
<h4>&nbsp;&nbsp;<strong style="color: red">Glass</strong>&nbsp;&nbsp;&nbsp;Cocktail Glass</h4> 
<h4>&nbsp;&nbsp;<strong style="color: red">Garnish</strong>&nbsp;&nbsp;&nbsp;Cherry</h4> 
...
<br>
 <div class="row">
    <div class="col">
<img src="../images2/올드패션드.jpg"  class="img-responsive" style="width: 250px;" align="left">
<h2 style="color: white;">&nbsp;&nbsp;Old Fashioned</h2><br>
<h4>&nbsp;&nbsp;<strong style="color: red;">Recipe</strong> Bourbon Wishkey 1.1 / 2oz<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cube Sugar 1ea<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Angrostura Bitters 1dash<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Club soda 1 / 2oz
</h4>
<h4>&nbsp;&nbsp;<strong style="color: red">Glass</strong>&nbsp;&nbsp;&nbsp;Old Fashioned Glass</h4> 
<h4>&nbsp;&nbsp;<strong style="color: red">Garnish</strong>&nbsp;&nbsp;&nbsp;Orange Slice & Cherry</h4> 
</div>
</div>
<br>
 <div class="row">
    <div class="col">
<img src="../images2/러스티네일.jpg"  class="img-responsive" style="width: 250px;" align="left">
<h2 style="color: white;">&nbsp;&nbsp;Rusty Nail</h2><br>
<h4>&nbsp;&nbsp;<strong style="color: red;">Recipe</strong> Bourbon Wishkey 1oz<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Drambuie 1 / 2oz
</h4>
<h4>&nbsp;&nbsp;<strong style="color: red">Glass</strong>&nbsp;&nbsp;&nbsp;Old Fashioned Glass</h4> 
